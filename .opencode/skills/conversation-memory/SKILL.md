...
Use the helper script from this skill directory or call it by absolute path:
...
From the dotfiles repository root, use `.opencode/skills/conversation-memory/commands/memory.sh`.
