...
- Start at Plan by default: if the user asks to "just do X," ask whether to skip planning/tasking. Without an explicit yes to skip, run Planner then Task Manager before Build.
